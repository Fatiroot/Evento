		...
		<div class="flex items-center md:space-x-4">
			<div class="relative">
				...
				<form action="" method="GET">
					@csrf
				<input type="search" name="keyword" placeholder="Search..." class="w-32 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none dark:bg-gray-800 dark:text-gray-100 focus:dark:bg-gray-900">
