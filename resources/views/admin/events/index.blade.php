            ...
            <tbody>
               @foreach ($events as $event )
                <tr>
                    ...
                    <td class="px-6 py-4 text-center">
                    <form method="POST" action="{{ route('events.update', $event->id) }}" id="update-event-form">
                        @csrf
                        @method('PUT')
                        <a href="#" class="hover:text-blue-500" onclick="event.preventDefault(); document.getElementById('update-event-form').submit();">
                            <p class="text-gray-900 whitespace-no-wrap">
                                ...
                                @else
                                <span class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-indigo-300">Refuesed</span>
                                @endif
                            </p>
                        </a>
                    </form>
