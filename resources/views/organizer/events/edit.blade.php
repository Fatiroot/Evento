    ...
    <div class="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
      ...
      <form action="{{route('events.update', $event->id)}}"  method="post" enctype="multipart/form-data">
        ...
        <div class="divide-y divide-gray-200">
          ...
          <div class="flex flex-col">
            ...
            <div class="flex flex-col">
              ...
              <select id="category_id" name="category_id" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" required>
                <option value="{{$event->category_id}}">Select a Category</option>
            ...
            <div class="flex items-center space-x-4">
              <div class="flex flex-col">
                ...
                <div class="relative focus-within:text-gray-600 text-gray-400">
                  <input type="date" name="start_date" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="25/02/2020" value="{{$event->start_date}}">
              ...
              <div class="flex flex-col">
                ...
                <div class="relative focus-within:text-gray-600 text-gray-400">
                  <input type="date" name="end_date" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="26/02/2020" value="{{$event->end_date}}">
                  <div class="absolute left-3 top-2">
                  </div>
                </div>
              </div>
          ...
          <a href="../events" class="block text-gray-900 px-4 py-3 rounded-md focus:outline-none flex justify-center items-center w-full">
